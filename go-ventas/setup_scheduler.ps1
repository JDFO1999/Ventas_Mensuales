...
$trigger = New-ScheduledTaskTrigger -Once -At "08:00" -RepetitionInterval (New-TimeSpan -Minutes 60) -RepetitionDuration (New-TimeSpan -Hours 9)
...
try {
    ...
    Write-Host "Tarea creada: $taskName (08:00 a 17:00, cada 60 min)"
} catch {
    Write-Host "ERROR: $_"
}
